...
export const exchangePublicToken = async ({
  ...
  try {
    ...
    // Create a funding source URl for the account using Dwolla customeriD, processor token and bank name
    ...
    // Create bank account using userId, itemId, accountId, accessToken, fundingsourceUr and sharableId
    ...
    // Revalidate the path to refresh the changes
    revalidatePath("/");
